        ...
        >
            <div class="flex justify-between">
                ...
                <div class="flex items-center justify-between gap-8">
                    ...
                    <span
                        class="icon-arrow-left rtl:icon-arrow-right-stylish inline-block cursor-pointer text-2xl max-lg:hidden"
                        role="button"
                    ...
                    <span
                        class="icon-arrow-right rtl:icon-arrow-left-stylish inline-block cursor-pointer text-2xl max-lg:hidden"
                        role="button"
            ...
            <a
                :href="navigationLink"
                class="secondary-button mx-auto mt-5 block w-max rounded-lg px-11 py-3 text-center text-base max-lg:mt-0 max-lg:hidden max-lg:py-3.5 max-md:rounded-lg"
                :aria-label="title"
                v-if="navigationLink"
            >
                @lang('shop::app.components.products.carousel.view-all')
